...
class HomeController {
    ...
    fun getHome(): ResponseEntity<*> = ResponseEntity.ok(
        siren(HomeOutputModel()) {
            ...
            recipeLinks(UriTemplate(Uris.Games.GET_ALL_GAMES), Rels.GET_ALL_GAMES)
            recipeLinks(UriTemplate(Uris.Games.GET_ALL_GAMES_BY_USER), Rels.GET_ALL_GAMES_BY_USER)
            ...
            recipeLinks(UriTemplate(Uris.Users.GET_STATS_BY_USERNAME + "?name"), Rels.USER_STATS)
